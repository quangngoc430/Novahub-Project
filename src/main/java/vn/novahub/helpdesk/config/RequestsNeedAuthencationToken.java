...
public class RequestsNeedAuthencationToken {
    ...
    public static ArrayList<Request> get() {
        if(requestArrayList == null) {
            ...
            requestArrayList.add(new Request("\\/api\\/admin\\/day-offs\\/(\\d+)\\/answer", new String[]{Method.GET.name(), Method.PUT.name(), Method.DELETE.name()}));

            // day-off-accounts
            requestArrayList.add(new Request("\\/api\\/day-off-accounts", new String[]{Method.POST.name(), Method.PUT.name(), Method.GET.name()}));
            requestArrayList.add(new Request("\\/api\\/day-off-accounts\\/(\\d+)", new String[]{Method.GET.name(), Method.DELETE.name()}));
            requestArrayList.add(new Request("\\/api\\/day-off-accounts\\/(\\d+)", new String[]{Method.GET.name(), Method.DELETE.name()}));
            requestArrayList.add(new Request("\\/api\\/admin\\/day-off-accounts", new String[]{Method.POST.name(), Method.PUT.name(), Method.GET.name()}));
            requestArrayList.add(new Request("\\/api\\/admin\\/day-off-accounts\\/(\\d+)", new String[]{Method.GET.name(), Method.PUT.name(), Method.DELETE.name()}));
            requestArrayList.add(new Request("\\/api\\/admin\\/day-off-accounts\\/generate\\/(\\d+)", new String[]{Method.GET.name(), Method.PUT.name(), Method.DELETE.name()}));
            requestArrayList.add(new Request("\\/api\\/admin\\/day-off-accounts\\/delete\\/(\\d+)", new String[]{Method.GET.name(), Method.PUT.name(), Method.DELETE.name()}));
            ...
            requestArrayList.add(new Request("\\/api\\/admin\\/day-off-types\\/(\\d+)", new String[]{Method.GET.name(), Method.PUT.name(), Method.DELETE.name()}));
